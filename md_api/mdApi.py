...
class CtpMdApi(MdApi):
    ...
    def onFrontConnected(self):
        ...
        self.log_signal.send(log_message=sys_constant.DATA_SERVER_CONNECTED)
        self.login()
    ...
    def onFrontDisconnected(self, n):
        ...
        self.mdConnected = False
        self.log_signal.send(log_message=sys_constant.DATA_SERVER_DISCONNECTED,log_level=ERROR_LEVEL)
    ...
    def onRspError(self, error, n, last):
        ...
        self.log_signal.send(log_message=error.errorMsg, log_level=ERROR_LEVEL)
    ...
    def onRspUserLogin(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            ...
            self.log_signal.send(log_message=sys_constant.DATA_SERVER_LOGIN)
    ...
    def onRspUserLogout(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            self.loginStatus = False
            self.mdConnected = False
            self.log_signal.send(log_message=text.DATA_SERVER_LOGOUT)
    ...
    def onRtnDepthMarketData(self, data):
        ...
        event = Event(dict=tick, type_=EVENT_TICK)
    ...
    def writeLog(self, content):
        ...
        self.log_signal.send(log_message=log.logContent)
