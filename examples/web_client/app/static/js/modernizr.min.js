...
;window.Modernizr = function (a, b, c) {
    ...
    return e.input || K(), e.addTest = function (a, b) {
        ...
        var r = {
            elements: c.elements || "abbr article aside audio bdi canvas data.json datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
            shivCSS: c.shivCSS !== !1,
